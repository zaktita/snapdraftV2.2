        ...
        <AppLayout>
            ...
            <div className="p-8 space-y-8">
                ...
                <div>
                    ...
                    <p className="text-gray-600 mt-1">Find your projects and images</p>
                </div>
                    ...
                    <div className="text-center">
                        ...
                        <div className="flex items-center justify-center gap-6 mt-8">
                            <div className="text-center">
                                ...
                                <p className="text-sm text-gray-600">Search Projects</p>
                            </div>
                            <div className="text-center">
                                <Image className="h-8 w-8 text-green-500 mx-auto mb-2" />
                                <p className="text-sm text-gray-600">Find Images</p>
                            </div>
                            <div className="text-center">
