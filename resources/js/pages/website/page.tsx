...
import FAQSection from "./components/Section/Home-3/Faq/Faq";
import Pricing from "./components/Section/Common/Pricing/Pricing";
...
export default function HomeThreePage() {
  return (
    <>
      ...
      <HomeHeader logoSrc="/images/logo/logo.png" roundedBtn="true" />
      <HeroSection />
      <ServiceSection />
      <ContentSection />
      <ContentSectionTwo />
